  ...
  const cargarProductos = (inputValue) =>
    Promise.resolve(
      productos
        ...
        .map((p) => ({
          value: p.id_producto,
          label: `${p.nombre_producto} - C$${p.precio_producto}`,
          data: p,
        }))
    );
    ...
    >
              ...
              >
                {detalles.length === 0 ? (
                  <div className="text-center py-5 text-muted">
                    ...
                    <p className="mt-2">No hay productos agregados aún</p>
                  </div>
                ) : (
                        ...
                        <div>
                          ...
                          <div className="d-flex align-items-center gap-2 mt-1">
                            <Form.Control
                              ...
                              size="sm"
                            />
                            <small className="text-muted">× C${det.precio}</small>
                          </div>
                        </div>
      ...
      <Modal.Footer>
        ...
        <Button
          ...
          disabled={
            !clienteSeleccionado || !empleadoSeleccionado || detalles.length === 0
          }
        >
